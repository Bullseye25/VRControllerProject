...
public class GvrEditorEmulator : MonoBehaviour 
{
  ...
  public static Vector3 HeadPosition { get;  set; }

  public static Quaternion HeadRotation { get;  set; }

    //public VirtualJoystick m_vJ;
  ...
  void Update() 
    ...
    if (CanChangeYawPitch()) 
        {
            GvrCursorHelper.HeadEmulationActive = true; //lock Mouse
        ...
        while (validCameras.MoveNext()) 
        {
            ...
            //HeadPosition += m_vJ.InputVector;  //(HeadRotation * LameWalk.instance.MoveUpdate()) * cam.transform.lossyScale.y;
